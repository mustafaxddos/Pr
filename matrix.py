...
# --- Configuration ---
bot = telebot.TeleBot('7718655847:AAGf4kBc5UUL80Nhxbq03f3S9Bj3STHR8y0')

# Admin user IDs
admin_id = {"6103581760"}  # Replace with actual admin ID
...
def generate_key(length=10):
    ...
    return f"MUSTAFA-VIP-{key.upper()}"  # Ensure key is in uppercase
...
def generate_key_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗔𝗱𝗺𝗶𝗻 @SIDIKI_MUSTAFA_47"
